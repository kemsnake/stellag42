...
<div id="footer">
  ...
  <div class="footer_credit">
   ...
   <?php endif; ?>
    ...
    <div id="copyright">
     <p class="copyright"><?php print t('Copyright'); ?> &copy; <?php echo date("Y"); ?>, <?php print $site_name; ?> </p> <p class="credits"> <a href="http://www.zymphonies.com">Zymphonies</a> & <a href="http://drupalstyle.ru/">Drupal Шаблоны</a></p>
    <div class="clear"></div>
    </div>
  </div>
  </div>
