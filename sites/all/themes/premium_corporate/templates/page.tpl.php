...
<div id="wrap" class="clearfix">
  ...
  <div id="slider-wrap">
    <div id="slider_nivo" class="nivoSlider"> 
      <img src="<?php print base_path() . drupal_get_path('theme', 'premium_corporate') . '/images/slide-image-1.jpg'; ?>" height="360" width="970" <?php if ($slide1_cap) { print 'title="#caption0"'; } ?> />
      <img src="<?php print base_path() . drupal_get_path('theme', 'premium_corporate') . '/images/slide-image-2.jpg'; ?>" height="360" width="970" <?php if ($slide2_cap) { print 'title="#caption1"'; } ?> />
      <img src="<?php print base_path() . drupal_get_path('theme', 'premium_corporate') . '/images/slide-image-3.jpg'; ?>" height="360" width="970" <?php if ($slide3_cap) { print 'title="#caption2"'; } ?> />
    </div>
...
<a href="http://www.devsaran.com" target="_blank">Devsaran</a> - <a href="http://drupalstyle.ru/">Drupal Темы</a>
      </div>
      <div id="back-to-top">
